...
**Action:** Inserted **Sprint 00 (1 week)** before Sprint 01 to fix these issues.

See: `PROFESSOR_FEEDBACK_ANALYSIS.md` and `sprint-00-hot-fixes.md`
...
```
Timeline (9-11 weeks total, +1 week for hot fixes):

Week 1:    Sprint 00 - Critical Hot Fixes 🔥 NEW!
...
Week 2-4:  Sprint 01 - Critical MVP/Thesis
...
Week 5-6:  Sprint 02 - Production Quality
...
Week 7-9:  Sprint 03 - VocBench Integration
...
### 🔥 v0.2.0 - Hot Fixes (Sprint 00 - Week 1) **NEW**

**Target Date:** 1 week (ASAP)
...
### 🎯 v0.5.0 - Thesis MVP (Sprint 01 - Week 4)

**Target Date:** 4 weeks from start (was 3 weeks, +1 for Sprint 00)
...
### 🎯 v0.8.0 - Production Quality (Sprint 02 - Week 6)

**Target Date:** 6 weeks from start (adjusted for Sprint 00)
...
### 🎯 v1.0.0 - Production Release (Sprint 03 - Week 9)

**Target Date:** 9 weeks from start (adjusted for Sprint 00)
...
### Sprint 00: Critical Hot Fixes (1 week) - **38 Story Points** 🆕
...
### Sprint 01: Critical MVP (3 weeks) - **46 Story Points**
...
### Sprint 02: Production Quality (2 weeks) - **41 Story Points**
...
### Sprint 03: VocBench Integration (2-3 weeks) - **51 Story Points** (Updated)
...
```mermaid
graph TB
    A[v0.1.0 Current] --> B[US-02 Validation]
    B --> C[US-01 VocBench Integration]
    C --> D[US-03 Extended Fields]
    D --> E[US-04 Edge Tests]
    E --> F[v0.5.0 Thesis MVP]

    F --> G[US-08 Complete Types]
    G --> H[US-09 Name Parsing]
    H --> I[US-12 JavaDoc]
    I --> J[v0.8.0 Production Quality]

    J --> K[US-15 VocBench UI]
    K --> L[US-21 Packaging]
    L --> M[US-22 Integration Tests]
    M --> N[v1.0.0 Production Release]
...
1. **US-02 (Validation)** must complete before testing work
2. **US-01 (VocBench)** blocks all plugin features
3. **US-03 (Fields)** needed for comprehensive testing
4. **US-15 (UI)** needs Sprint 01 completion
...
1. **VocBench UI Integration (US-15)**
   ...
   - Complex integration
   - **Mitigation:** Research early, allocate extra time, consider minimal UI first
...
3. **Time Constraints (Sprint 01)**
   - Thesis deadline pressure
   - Ambitious scope
   - **Mitigation:** Prioritize ruthlessly, descope if needed
...
### ⚠️ Sprint 00 Replaces Week 1 Plan
